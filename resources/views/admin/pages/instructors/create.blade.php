            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.instructors.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        <div class="row my-4">
                            <div class="col-md-6">
                                    <input type="text" class="form-control"  name="position_en" placeholder="Enter position">
                                    @error('position_en')
                                    <div class="text text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control"  name="position_ar" placeholder="ادخل المنصب">
                                @error('position_ar')
                                <div class="text text-danger">{{ $message }}</div>
                                @enderror
                            </div>
