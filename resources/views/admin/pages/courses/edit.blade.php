                        ...
                        <form method="POST" action="{{ route('admin.courses.update', $course->id) }}"  enctype="multipart/form-data">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="name_ar" value="{{ $course->name_ar }}" placeholder="ادخل اسم الكورس">
                                    @error('name_ar') <div class="text-danger mt-1">{{ $message }}</div> @enderror
                                </div>

                                <div class="col-md-6">
                                    <label for="name_en" class="form-label">Course Name</label>
                                    <input type="text" class="form-control" name="name_en" value="{{ $course->name_en }}" placeholder="Enter course name">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" rows="4" name="description_ar" value="" placeholder="ادخل الوصف">{{ $course->description_ar }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" rows="4" name="description_en" value="" placeholder="Enter description">{{ $course->description_en }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="link_zoom" value="{{ $course->link_zoom }}" placeholder="Enter Zoom Link">
                                    @error('link_zoom') <div class="text-danger mt-1">{{ $message }}</div> @enderror
                                </div>

                                <div class="col-md-6">
                                    <label for="video" class="form-label">Iframe Video Link</label>
                                    <input type="text" class="form-control" name="video" value="{{ $course->video }}" placeholder="Enter iframe link">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="price" value="{{ $course->price }}" placeholder="Enter Price">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="status">
                                        ...
                                        <option @selected($course->status == 1) value="1">Active</option>
                                        <option @selected($course->status == 0) value="0">Inactive</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="stage_id">
                                        ...
                                        @foreach ($stages as $stage)
                                            <option @selected($course->stage_id == $stage->id) value="{{ $stage->id }}">{{ $stage->{'name_' . app()->getLocale()} }}</option>
                                        @endforeach
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="grade_id">
                                        ...
                                        @foreach ($grades as $grade)
                                            <option @selected($course->grade_id == $grade->id) value="{{ $grade->id }}">{{ $grade->{'name_' . app()->getLocale()} }}</option>
                                        @endforeach
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="instructor_id[]" class="form-control">
                                        @foreach($instructors as $instructor)
                                            <option                 @selected(in_array($instructor->id, $course->instructors->pluck('id')->toArray()))
                                                value="{{ $instructor->id }}">{{ $instructor->{'name_' . app()->getLocale()} }}</option>
                                        @endforeach
                                    </select>
                                    @error('instructor_id')
